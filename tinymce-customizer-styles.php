...
function kwh_add_editor_style( $mceInit ) {
	 ...
	 *
	 * NOTE: This function by itself will do nothing. It must be filtered with 'kwh_theme_mods' to change the styles at all. This is by design so this file can simply be a drop-in.
	 */
	$theme_mods = array();
